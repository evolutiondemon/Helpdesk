...
<html>
    ...
    <body>
        ...
        <div id="show-tickets" class="content scaffold-show" role="main">
            ...
            <f:display bean="tickets" />
            <g:form resource="${this.tickets}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tickets}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
